...
| v2-c | eba465a (incl 5a40b7d) | V2-c rhythm polish: plate TOC + lead red bar + spacing | PASS 2026-09-09 | git checkout v2-c / diff v2..v2-c |
...
| docs/ui-changelog/v2-c.md | 5a40b7d | plate TOC + lead red bar + title/summary spacing |
| docs/versions.md | eba465a | rewrite ASCII + add v2-c row |
